...
public class Dbms{
    public static void main(String[] args){
        ...
        long male = list.stream().map(x->x.gender.equals("Male")).collect(Collectors.toList()).size();
        long female = list.stream().map(x->x.gender.equals("Female")).collect(Collectors.toList()).size();
